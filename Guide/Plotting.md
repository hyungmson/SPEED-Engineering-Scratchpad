...
```
- After the update, 8 plots (2 scatter plots, 1 heatmap plot and 6 histogram plots) are shown on Plot tab:
```
// Plot of X:1D, Y:1D array pair
...
min = ARR.MIN(Arr1) = 1.45629159844719
max = ARR.MAX(Arr1) = 14.2294416440274
